...
SELECT Members.firstname, Members.surname, Facilities.name as Facility,
Case
...
SELECT m.surname ||', '|| m.firstname as name, r.surname AS rec_surname, r.firstname AS rec_firstname
FROM Members AS m
